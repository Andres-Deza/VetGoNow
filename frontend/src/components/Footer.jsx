    ...
    <div id="footer" className="mt-auto w-full bg-gray-200 pt-8 px-10"> {/* Added side paddings here */}
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 text-sm">
        ...
        <div>
          ...
          <p className="w-full md:w-2/3 text-gray-700 leading-6">
            VetGestion está aquí para ayudarte a conectarte con veterinarios de confianza para las necesidades de tu mascota y ganado. 
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            <li>+9779862971796</li>
            <li>vetgestionsupport@gmail.com</li> {/* Replace with your support email */}
          </ul>
        </div>
      ...
      <div>
        ...
        <p className="py-5 text-sm text-center text-gray-700">
          Copyright 2025 @ VetGestion - Todos los Derechos Reservados.
        </p>
      </div>
    </div>
  );
